...
export default function TrialPage() {
  ...
  return <main className="trial-page">
    <section className="trial-aside"><Link className="landing-brand light-brand" href="/"><span>QM</span><div><strong>qrmenülerim</strong><small>DİJİTAL MENÜ SİSTEMİ</small></div></Link><div className="trial-aside-copy"><span className="hero-kicker">24 SAAT ÜCRETSİZ DENEME</span><h1>Menünüzü bugün yayına alın.</h1><p>İşletme profilinizi oluşturun; örnek içerikle gelen panelde ürünleri, fiyatları ve görünümü dilediğiniz gibi düzenleyin.</p><ul><li><span>✓</span> Kredi kartı gerekmez</li><li><span>✓</span> Kategori ve ürün yönetimi</li><li><span>✓</span> Tema, favoriler ve canlı menü</li><li><span>✓</span> API bağlantısı</li></ul></div><div className="trial-quote"><span>24</span><p>Hesabınız açılır açılmaz tüm özellikleri kullanabilir, hazırladığınız menüyü gerçek bağlantısında inceleyebilirsiniz.</p></div></section>
    <section className="trial-form-wrap">
      ...
      <footer className="global-signature">Zaten hesabınız var mı? <Link href="/login">Panele giriş</Link><span>·</span>Tasarım ve geliştirme <a href={PERSONAL_SITE} target="_blank" rel="noreferrer">Ümican Çınar ↗</a></footer>
    </section>
  </main>;
}
