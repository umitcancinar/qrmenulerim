...
const headers: Record<Tab, { eyebrow: string; title: string; copy: string }> = {
  ...
  appearance: { eyebrow: 'MARKA GÖRÜNÜMÜ', title: 'Menünü markana göre ayarla.', copy: 'Bu alanlardaki değişiklikler doğrudan işletmene uygulanır.' },
  integration: { eyebrow: 'API ENTEGRASYON', title: 'Menüyü dış kaynaktan çek.', copy: 'Hazır menü API linkini gir; QR menü kategorileri ve ürünleri canlı kaynaktan alsın.' },
  analytics: { eyebrow: 'MENÜ ANALİTİĞİ', title: 'Menü içeriğin.', copy: 'İçerik sayıları ve öne çıkanlar tek bakışta burada.' },
  account: { eyebrow: 'HESAP AYARLARI', title: 'Hesabını yönet.', copy: 'Giriş bilgilerin bu panel hesabına anında uygulanır.' },
};
...
export default function PanelClient({
  ...
  return <main className="panel-page">
    <aside className="panel-sidebar">
      ...
      <nav>{nav('menu', '▦ Menü içerikleri')}{nav('appearance', '◉ Görünüm ve tema')}{nav('integration', '⌘ API entegrasyon')}{nav('analytics', '⌁ Analitik')}{nav('account', '⚙ Hesap ayarları')}</nav>
